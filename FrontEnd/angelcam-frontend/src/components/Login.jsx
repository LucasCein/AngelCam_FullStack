        ...
        <div className='flex flex-col items-center my-10'>
            ...
            <form onSubmit={handleSubmit} className='w-full max-w-sm'>
                <div className='mb-4'>
                    ...
                    <input className='shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline' type="text" id="token" value={token} onChange={(e) => setToken(e.target.value)} required />
                </div>
